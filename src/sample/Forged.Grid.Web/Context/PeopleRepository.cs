...
namespace Forged.Grid.Web.Context
{
        ...
        public IQueryable<Person> GetPeople(string search = "")
        {
            ...
            return new List<Person>
            {
                new Person(1, "Joe", "Crosswave")
                {
                    ...
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 32, 01, 05)).TotalDays / 365,
                    ...
                    Children = new List<Person>
                    {
                        ...
                        {
                            Age = (int)(DateTime.Now - new DateTime(currentYear - 5, 01, 05)).TotalDays / 365,
                ...
                new Person(2, "Merry", "Lisel")
                {
                    ...
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 42, 05, 06)).TotalDays / 365,
                    Birthday = new DateTime(currentYear - 42, 05, 06)
                },
                new Person(3, "Henry", "Crux")
                {
                    MaritalStatus = MaritalStatus.Single,
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 30, 11, 19)).TotalDays / 365,
                    Birthday = new DateTime(currentYear - 30, 11, 19),
                    IsWorking = true
                },
                new Person(4, "Cody", "Jurut")
                {
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 50, 08, 11)).TotalDays / 365,
                ...
                {
                    MaritalStatus = MaritalStatus.Single,
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 35, 10, 10)).TotalDays / 365,
                    Birthday = new DateTime(currentYear - 35, 10, 10)
                },
                new Person(6, "Leena", "Laurent")
                {
                    MaritalStatus = MaritalStatus.Divorced,
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 20, 07, 01)).TotalDays / 365,
                ...
                {
                    MaritalStatus = MaritalStatus.Married,
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 54, 04, 17)).TotalDays / 365,
                    ...
                    Children = new List<Person>
                    {
                        ...
                        {
                            Age = (int)(DateTime.Now - new DateTime(currentYear - 6, 07, 14)).TotalDays / 365,
                ...
                {
                    MaritalStatus = MaritalStatus.Single,
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 21, 08, 20)).TotalDays / 365,
                ...
                {
                    MaritalStatus = MaritalStatus.Married,
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 23, 03, 13)).TotalDays / 365,
                ...
                new Person(10, "Nicky", "Tremblay")
                {
                    ...
                    Children = new List<Person>
                    {
                        ...
                        {
                            Age = (int)(DateTime.Now - new DateTime(currentYear - 7, 06, 08)).TotalDays / 365,
                            Birthday = new DateTime(currentYear - 7, 06, 08)
                        },
                        new Person(102, "Nike", "Tremblay")
                        {
                            Age = (int)(DateTime.Now - new DateTime(currentYear - 6, 12, 12)).TotalDays / 365,
                            Birthday = new DateTime(currentYear - 6, 12, 12)
                        },
                        new Person(103, "Norbert", "Tremblay")
                        {
                            Age = (int)(DateTime.Now - new DateTime(currentYear - 5, 05, 23)).TotalDays / 365,
                ...
                {
                    MaritalStatus = MaritalStatus.Married,
                    Age = (int)(DateTime.Now - new DateTime(currentYear - 25, 07, 10)).TotalDays / 365,
